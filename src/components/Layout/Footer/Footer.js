    ...
    <div>
      <div style={{ backgroundColor: "white", padding: 48 }}>
        ...
        >
          ...
          >
            <img src={"assets/img/footer/brands.png"} style={{ height: 100 }} />
          </div>
          <h1 className="mt-40" style={{ color: "#56B24B" }}>
            CONTACT US
          </h1>
      ...
      <div style={{ height: 30, backgroundColor: "#15375B" }} />
      <div style={{ height: 40, backgroundColor: "#56B24B" }} />
    </div>
  );
};
